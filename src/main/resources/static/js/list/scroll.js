$(function(){
        ...
        let title = "";
          ...
          $.ajax({
            ...
            <div class="content-container">
               ...
               <div class="camp-id" style="display:none;">${search.id}</div>
            </div>
             <div class="icon-list">
                 ...
                 <div class="list-container">
                   ...
                   <div class="content-container">
                     ...
                     <div class="comfor">${camping.faclity }</div>
                      <div class="camp-id" style="display:none;">${camping.id}</div>
                   </div>
                   <div class="icon-list">
                     <div class="icons list-map">
                        <div class="icon map-icon">
 ...
 //console.log(event.target.className);
   if (event.target.className == "icons message-icons"
                            ...
                            var messageCampName = document.querySelector(".message-campName");
                                    var target2Sibling =target2.previousElementSibling;
                                        ...
                                        //console.log(campIdText);                                     
                                         ...
                                         var textArea = document.querySelector("#writeNote");
                                         textArea.value = messageTitle2+'\n'  ;
   ...
   if (event.target.className == "icons list-map"
                        ...
                        || event.target.className == "icon map-icon"
