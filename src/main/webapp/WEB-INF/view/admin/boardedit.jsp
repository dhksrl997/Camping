...
<div class="adminConWrap">
      <div class="infoWrap">
         ...
         <button type="button" class="regbtn"
            onclick="location.href='boardlist'">수정하기</button>
            ...
            <div class="editTable">
               ...
               <table class="table-part2">
                  <tr>
                     ...
                     <td class="info-con"><input type="text" autocomplete="off"
                        name="title" id="input" required value="${board.title}">
                     </td>
                  </tr>
                  <tr>
                     <td class="info-tit">파일 선택</td>
                     <td class="filebox info-con" colspan="4"><input type="file"
                        autocomplete="off" name="file" id="input" required value="">
                     </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                     ...
                     <td class="info-con" colspan="4">
                        <form>
                           ...
                           <label for="comments">댓글 허용</label> <input type="radio"
                              autocomplete="off" name="disable" required
                  ...
                  <tr>
                     ...
                     <td class="info-con">
                        <form>
                           <input type="radio" name="posting" required> <label
                              for="posting">공개</label> <input type="radio" name="private"
                              required style="margin-left: 40px;"> <label
                              for="private">비공개</label>
                        </form>
                     </td>
                     <td class="info-tit">등록 일자</td>
                     <td class="info-con"><input type="date" autocomplete="off"
                        id="name" name="regdate" required minlength="5" maxlength="8"
                        size="15" value="${board.regDate}"></td>
                  </tr>
               </table>
            </div>
      </div>
