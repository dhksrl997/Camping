...
<c:if test="${param.query!=null }">
	<div
		style="padding-top: 50px; text-align: center; padding-bottom: 50px; font-size: 24px;">${param.query }에
		대한 ${index }개의 검색결과 입니다.</div>
	<div class="camp-list">
...
<c:if test="${param.query==null }">
	...
	<c:if test="${param.reg == null }">
		<div class="Message1">
			<span>이</span><span>런</span>&nbsp;&nbsp;<span>캠</span><span>핑</span><span>장</span>
		</div>
		<div class="Message2">
			<span>어</span><span>떠</span><span>세</span><span>요</span><span>!</span>
		</div>



		<div class="random-message">
			<span class="rec-Button">캠핑장 랜덤추천 <i class="fas fa-redo"></i>
			</span>
		</div>
						...
						<div class="icon-list">
							...
							<div id="message" class="message hide">
								...
								<div class="writing_area">
									<textarea id="writeNote" style="resize: none;" rows="5"
										cols="55" title="쪽지 내용을 입력해 주세요."></textarea>
